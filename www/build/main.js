...
var InicioPage = (function () {
    ...
    InicioPage.prototype.direcciones = function () {
    ...
    InicioPage.prototype.registrarUsuario = function () {
        var prompt = this.alertCtrl.create({
